...
class CalendarList extends Component {
  ...
  static defaultProps = {
    ...
    disableInitialScrollIndex: false,
    scrollEnabled: true,
    scrollsToTop: false,
    ...
    return (
      <View>
        <FlatList
          ...
          initialScrollIndex={this.state.openDate && !this.props.disableInitialScrollIndex ? this.getMonthIndex(this.state.openDate) : false}
